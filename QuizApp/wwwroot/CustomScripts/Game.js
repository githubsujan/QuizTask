            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 200) {
                        ...
                        $('#divAlertReponse').removeClass("alert-danger");
                        $('#divAlertReponse').addClass("alert-success");
                        ...
                        $('#divAlertReponse').removeClass("alert-success");
                        $('#divAlertReponse').addClass("alert-danger");
